...
Adafruit_MQTT_Publish printer1 = Adafruit_MQTT_Publish(&mqtt, "/3dPrinter/P1");
// Setup a feed called 'onoff' for subscribing to changes.
Adafruit_MQTT_Subscribe p1commands = Adafruit_MQTT_Subscribe(&mqtt, "/3dPrinter/P1/commands");
/*************************** Sketch Code ************************************/
